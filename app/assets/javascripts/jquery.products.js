var Products = function (obj) {
    ...
    var _self = this,
        ...
        _newProduct = new NewProduct( _obj.find( '.content__filter-new' ) ),
        _tableBody = _obj.find( '.table__body' ),
        _contextMenu = _tableBody.find( '.context' ),
        _productId = null,
        _confirmBtn = _contextMenu.find( '.products__confirm' ),
        _removeBtn = _contextMenu.find( '.products__delete' ),
        _currentRow = null,
...
var NewProduct = function ( obj ) {
    ...
    var _addForm = function ( html ) {
        ...
        _createForm = function () {
            _container = $( '<div class="new-product loader"></div>' );
